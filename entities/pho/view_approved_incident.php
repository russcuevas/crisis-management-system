...
if (isset($_GET['incident_id'])) {
    ...
    if (!$incident) {
        ...
        header('location:pho_approved.php');
        exit();
    }
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol style="font-size: 15px;" class="breadcrumb breadcrumb-col-red">
                    ...
                    <li><a href="pho_approved.php"><i style="font-size: 20px;" class="material-icons">check</i> Approved Complaints</a></li>
                        ...
                        <div class="body">
                            ...
                            <div style="display: flex !important; justify-content: end; gap: 10px;">
                                <form method="POST">
                                    ...
                                    <a href="pho_approved.php" class="btn btn-primary">Go back</a>
                                </form>
                            </div>
                        </div>
                    </div>
