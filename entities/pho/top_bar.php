...
<nav class="navbar" style="background-color: white !important;">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a id="app-title" style="display:flex;align-items:center" class="navbar-brand" href="pho_dashboard.php">
                <img id="bcas-logo" style="background-color: none !important; width:45px;display:inline;margin-right:10px; border-radius: 50px;" src="images/pho-logo.png" />
                <span style="color: black;">Provincial Health Office</span>
            </a>
        </div>
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <!-- #END# Notifications -->
                <li class="pull-right"><a href="javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="material-icons" style="color: black;">account_circle</i></a></li>
            </ul>
        </div>
    </div>
</nav>
