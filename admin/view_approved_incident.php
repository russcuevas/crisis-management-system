...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete'])) {
        ...
        $_SESSION['approve_success'] = 'Incident deleted successfully.';
        header("Location: approve_complain.php");
        exit();
    }
}
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol style="font-size: 15px;" class="breadcrumb breadcrumb-col-red">
                    ...
                    <li><a href="approve_complain.php"><i style="font-size: 20px;" class="material-icons">done_all</i> Approved Complaints</a></li>
                        ...
                        <div class="body">
                            ...
                            <div style="display: flex !important; justify-content: end; gap: 10px;">
                                <form method="POST">
                                    ...
                                    <a href="approve_complain.php" class="btn btn-primary">Go back</a>
                                </form>
                            </div>
                        </div>
                    </div>
